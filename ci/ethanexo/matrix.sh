...
export BUILDER_IMAGE_NAME="ethanexo-builder-$BUILD_TARGET-$JOB_NUMBER"
...
if [ "$BUILD_TARGET" = "arm-linux" ]; then
  ...
  export CPPFLAGS="-DDEBUG_LOCKORDER -DENABLE_ethanexo_DEBUG -DARENA_DEBUG"
  export PYZMQ=true
