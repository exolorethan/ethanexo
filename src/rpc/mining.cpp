        ...
        throw std::runtime_error(
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated ETXO to."},
...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
	...
	if(pblock->txoutFounder!= CTxOut()) {
		...
		founderObj.pushKV("payee", addressString.c_str());
    ...
    FounderPayment developmentPayment = Params().GetConsensus().nDevelopmentPayment;
