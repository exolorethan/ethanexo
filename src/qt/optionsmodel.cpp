...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::ETXO);
    ...
    if (!settings.contains("nCoinJoinAmount")) {
        ...
        if (!settings.contains("nAnonymizeETXOAmount"))
            settings.setValue("nCoinJoinAmount", DEFAULT_COINJOIN_AMOUNT);
        else
            settings.setValue("nCoinJoinAmount", settings.value("nAnonymizeETXOAmount").toInt());
    }
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        /*case ShowGovernanceTab: 
            return settings.value("fShowGovernanceTab"); */ //Hide Governance RaptorHide
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        /*case ShowGovernanceTab:
            ...
            break; */ //Hide Governance RaptorHide
        case CoinJoinEnabled:
