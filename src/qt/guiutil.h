...
/** Utility functions used by the ETXO Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ethanexo:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load ethanexo specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a ethanexo specific theme is activated (light/dark).*/
