Contributing to Ethanexo Core
============================

The Ethanexo Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/exolorethan/ethanexo/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
[Translation Process](https://github.com/exolorethan/ethanexo/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Ethanexo Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Ethanexo
Network Protocol consensus changes.

Whether a pull request is merged into Ethanexo Core rests with the project merge
...
Patches that change Ethanexo consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ethanexo consensus, it must have been
...
The review process is normally fairly responsive on the Ethanexo Core repository, however
...
Bitcoin Backports are an incredibly valuable part of Ethanexo's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for Ethanexo](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each Ethanexo Core release.
