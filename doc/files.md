...
* ethanexo.conf: contains configuration settings for ethanexod or ethanexo-qt
* ethanexod.pid: stores the process id of ethanexod while running
...
* debug.log: contains debug information and general logging generated by ethanexod or ethanexo-qt
