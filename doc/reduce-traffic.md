...
By default, Ethanexo Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that ethanexo's trustless model works best if you are
