UNIX BUILD NOTES
====================
Some notes on how to build Ethanexo Core in Unix.
...
-----------------------
Building the dependencies and Ethanexo Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your Ethanexo Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Ethanexo Core should be built with a non-executable stack,
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Ethanexo Core may be compiled in
