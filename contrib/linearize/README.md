# Linearize
Construct a linear, no-fork, best version of the Ethanexo blockchain.
...
JSON-RPC server. Running `ethanexod` or `ethanexo-qt -server` will be sufficient.
...
* `input`: ethanexod blocks/ directory containing blkNNNNN.dat
