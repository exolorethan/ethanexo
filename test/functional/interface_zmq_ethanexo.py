...
"""Test the ethanexo specific ZMQ notification interfaces."""
...
class EthanexoZMQTest (EthanexoTestFramework):
    def set_test_params(self):
        ...
        self.set_ethanexo_test_params(4, 3, fast_dip3_enforcement=True, extra_args=[node0_extra_args, [], [], []])
    ...
    def run_test(self):
        # Check that ethanexod has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all ethanexo related ZMQ publisher
