...
"""Tests around ethanexo governance objects."""
...
class EthanexoGovernanceTest (EthanexoTestFramework):
    def set_test_params(self):
        self.set_ethanexo_test_params(2, 1)
