...
"""Verify that starting ethanexod with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ethanexod with -h for help text")
        ...
        self.log.info("Start ethanexod with -version for version information")
        ...
        self.log.info("Start ethanexodd with -fakearg to make sure it does not start")
