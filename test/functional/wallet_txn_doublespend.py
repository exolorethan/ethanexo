...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 ETXO:
        ...
        # First: use raw transaction API to send 12400 ETXO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 ETXO coin each
        ...
        # Node0's balance should be starting balance, plus 500 ETXO for another
        ...
        # Node0's total balance should be starting balance, plus 1000 ETXO for
