...
class LLMQCoinbaseCommitmentsTest(EthanexoTestFramework):
    def set_test_params(self):
        self.set_ethanexo_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as EthanexoTestFramework doesn't support this atm)
